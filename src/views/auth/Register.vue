            ...
            <div class="row" bis_skin_checked="1">
              ...
              <div class="col-md-8" bis_skin_checked="1">
                ...
                <div class="standard-form-content" bis_skin_checked="1">
                  <form
                    action="/Register/RegisterSubmit?Length=8"
                    data-ajax="true"
                    data-ajax-begin="onAjaxRequestBegin"
                    data-ajax-complete="onAjaxRequestComplete"
                    data-ajax-method="POST"
                    data-ajax-success="onRegisterAjaxRequestSuccess"
                    data-copied-text="Disalin"
                    id="register_form"
                    method="post"
                  ...
                  >
                    <input
                      ...
                      type="hidden"
                      value="XP0vSkIhYxK5CYXZFEy0Y47JzX8mn30iPT_XEhqsLBSUA-xtAon3I-1G_hHyqbTVIcIsQaNC-AMPOwC-hz-Cci3hLMo1"
                    />
                    ...
                    <div class="standard-sub-section" bis_skin_checked="1">
                      ...
                      <div
                        class="standard-form-content form_subcategory"
                        bis_skin_checked="1"
                      >
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          <div data-section="input" bis_skin_checked="1">
                            <input
                              ...
                              data-val="true"
                              data-val-regex="Harap masukkan antara 3 - 12 karakter dalam alfanumerik.&lt;br&gt;Nama pengguna tidak boleh memiliki spasi."
                              data-val-regex-pattern="^[0-9a-zA-Z]{3,12}$"
                              data-val-remote="'UserName' is invalid."
                              data-val-remote-additionalfields="*.UserName"
                              data-val-remote-url="/validate/username"
                              data-val-required="Harap masukkan antara 3 - 12 karakter dalam alfanumerik.&lt;br&gt;Nama pengguna tidak boleh memiliki spasi."
                              id="username_field"
                              name="UserName"
                            ...
                            />
                            <span
                              class="field-validation-valid standard-required-message"
                        ...
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          >
                            <input
                              ...
                              class="form-control"
                              data-val="true"
                              data-val-regex="The field Password must match the regular expression '^(?=.{8,20}$)[A-Za-z0-9!@#$%^*()_+=\[\]{}|:;&quot;',.?/~`\\-]+$'."
                              data-val-regex-pattern="^(?=.{8,20}$)[A-Za-z0-9!@#$%^*()_+=\[\]{}|:;&quot;',.?/~`\\-]+$"
                            ...
                            <span class="standard-required-message"
                              >Kata Sandi harus terdiri dari 8-20 karakter, harus
                              mengandung huruf dan angka, dan tidak boleh mengandung
                              simbol &amp;, &lt;, atau &gt;.</span
                            >
                            <div
                              class="password-validations"
                              id="password_validations"
                              style="display: none"
                              bis_skin_checked="1"
                            >
                              <div
                                id="password_username_validation"
                                style="color: green"
                                bis_skin_checked="1"
                              >
                                <i
                              ...
                              <div
                                id="password_alphanumeric_validation"
                                style="color: red"
                                bis_skin_checked="1"
                              >
                                <i
                            ...
                            <i
                              class="glyphicon glyphicon-eye-close password_input_trigger"
                            ></i>
                          </div>
                        </div>
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          >
                            ...
                            />
                            <span class="standard-required-message"
                              >Konfirmasi kata sandi tidak cocok!</span
                            >
                            <i
                              class="glyphicon glyphicon-eye-close password_input_trigger"
                            ></i>
                        ...
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          <div data-section="input" bis_skin_checked="1">
                            <input
                              ...
                              class="form-control"
                              data-val="true"
                              data-val-email="Email salah."
                              data-val-remote="'Email' is invalid."
                              data-val-remote-additionalfields="*.Email"
                              data-val-remote-url="/validate/email"
                              id="Email"
                              name="Email"
                        ...
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          <div data-section="input" bis_skin_checked="1">
                            Silakan masukkan email yang aktif untuk tujuan reset kata
                            sandi
                          </div>
                        </div>
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          <div data-section="input" bis_skin_checked="1">
                            <input
                              class="form-control format_phone"
                              data-val="true"
                              data-val-regex="Harap masukkan numerik saja"
                              data-val-regex-pattern="^(?=.*[0-9])[0-9\-]+$"
                              data-val-remote="'WhatsApp' is invalid."
                              data-val-remote-additionalfields="*.WhatsApp"
                              data-val-remote-url="/validate/whatsapp"
                              id="WhatsApp"
                              inputmode="decimal"
                              name="WhatsApp"
                            ...
                            <span
                              class="field-validation-valid standard-required-message"
                              data-valmsg-for="WhatsApp"
                              data-valmsg-replace="true"
                            ></span>
                          </div>
                        </div>
                        <div
                          class="standard-inline-form-group referral-glyphicon-container"
                          bis_skin_checked="1"
                        >
                          <div
                            class="referral-code-header"
                            id="referral_code_header"
                            bis_skin_checked="1"
                          >
                          ...
                          <div
                            data-section="input"
                            class="referral-code-content"
                            id="referral_code_content"
                            bis_skin_checked="1"
                          >
                            <input
                              autocomplete="off"
                    ...
                    <div
                      class="standard-sub-section"
                      id="bank_account_section"
                      bis_skin_checked="1"
                    >
                      <div class="standard-form-title" bis_skin_checked="1">
                        ...
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          <div data-section="input" bis_skin_checked="1">
                            <select
                              class="form-control"
                              data-val="true"
                              data-val-required="Bank harus diisi."
                              id="selected_bank_select"
                              name="SelectedBank"
                            >
                              <option value="">-- Pilih Bank --</option>
                              <option value="e1bab23f-dda6-4835-b3ce-d5039f28546c">
                                BCA
                              </option>
                              <option value="3d30334c-d871-46fb-80b3-0fcb12f99b87">
                                BNI
                              </option>
                              <option value="a458ab91-91a3-49ac-98b3-1bfc5d1966bd">
                                BRI
                              </option>
                              <option value="d97905f0-ef0d-4e31-ad96-f4dc69dedbe5">
                                BSI
                              </option>
                              <option value="a54b63b0-4aee-49bc-b65d-21a61dd50e0f">
                                CIMB
                              </option>
                              <option value="60a8bb30-c0d8-4fd2-9646-5d79cca114ec">
                                DANA
                              </option>
                              <option value="67568e69-ca77-43c8-bf9b-df628bc3b2d6">
                                DANAMON
                              </option>
                              <option value="f3a032d6-dd8e-4652-978c-6678addbf211">
                                GOPAY
                              </option>
                              <option value="5991bbaf-9b29-4523-89e5-2ab8fd5ccbc7">
                                JAGO
                              </option>
                              <option value="6faf0720-db16-459e-904d-09d64d7c2483">
                                LINKAJA
                              </option>
                              <option value="ec4427ff-2e6e-4657-a2fe-b3702bc15e7c">
                                MANDIRI
                              </option>
                              <option value="97b7b74f-ed25-4483-b697-8e97fb5692a4">
                                OVO
                              </option>
                              <option value="3201c5d4-316a-4c64-a536-4282c716a57b">
                                QRIS AUTO
                              </option>
                              <option value="c3c024bc-e8e6-41b4-beba-103b109c7221">
                                SEABANK
                              </option>
                            </select>
                            <span
                              class="field-validation-valid standard-required-message"
                              data-valmsg-for="SelectedBank"
                              data-valmsg-replace="true"
                            ></span>
                          </div>
                        </div>
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          <div data-section="input" bis_skin_checked="1">
                            <input
                              maxlength="24"
                              autocomplete="off"
                              class="form-control format_account_number"
                              data-val="true"
                            ...
                            <span
                              class="field-validation-valid standard-required-message"
                              data-valmsg-for="BankAccountNumber"
                              data-valmsg-replace="true"
                            ></span>
                          </div>
                        </div>
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          <div data-section="input" bis_skin_checked="1">
                            <input
                              ...
                              class="form-control"
                              data-val="true"
                              data-val-equal-to="Nama rekening harus sama dengan nama lengkap Anda."
                              data-val-regex="The field BankAccountName must match the regular expression '^[\u4e00-\u9fa5\u0E00-\u0E7F\u0400-\u04FF\u00C0-\u00FF\u0100-\u017F\u0180-\u024Fa-zA-Z0-9\uFF10-\uFF19\uFF21-\uFF3A\uFF41-\uFF5A\u0905-\u097F\u3000 ]+$'."
                            ...
                            />
                            <span class="standard-required-message"
                              >Nama lengkap hanya boleh berisi karakter alfanumerik.</span
                            >
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="standard-sub-section" bis_skin_checked="1">
                      <div class="standard-form-title" bis_skin_checked="1">Lainnya</div>
                      <div
                        class="standard-form-content form_subcategory"
                        bis_skin_checked="1"
                      >
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          <label for="SelectedSourceInformation"
                            >Bagaimana Anda mengetahui situs kami?</label
                          >
                          <div data-section="asterisk" bis_skin_checked="1">*</div>
                          <div data-section="input" bis_skin_checked="1">
                            <select
                              class="form-control"
                              id="SelectedSourceInformation"
                              name="SelectedSourceInformation"
                              required="required"
                            >
                            ...
                            <span class="standard-required-message"
                              >Tolong pilih sumber informasi!</span
                            >
                          </div>
                        </div>
                        <div class="standard-inline-form-group" bis_skin_checked="1">
                          ...
                          >
                            ...
                            />
                            <span class="standard-required-message"
                              >Silakan masukkan CAPTCHA!</span
                            >
                            <div class="captcha-container" bis_skin_checked="1">
                              <i
                                class="glyphicon glyphicon-refresh refresh-captcha-button"
                                id="refresh_captcha_button"
                              ></i>
