    ...
    <div class="modal-dialog" bis_skin_checked="1">
      <div class="modal-content simple-modal" bis_skin_checked="1">
        <div class="modal-header" bis_skin_checked="1">
          ...
          <h4 class="modal-title text-white">{{ $t("auth.Login") }}</h4>
        </div>
        <hr />
        <div class="modal-body" bis_skin_checked="1">
          ...
          <Form class="form" @submit="onLogin" :validation-schema="rules">
            <div class="form-group" bis_skin_checked="1">
              <label for="UserName">{{ $t("auth.ID") }}</label>
              <Field
            ...
            <div class="form-group" bis_skin_checked="1">
              <label for="UserName">{{ $t("auth.Password") }}</label>
            ...
            <div class="form-group captcha-group">
              ...
              <div class="captcha-container">
                <div class="captcha-display" v-html="authStore.cvalue"></div>
                <Field
                  class="form-control form-control-solid captcha-input"
                  style="background-color: #080808; border-color: #393939; width: 100%;"
                  type="number"
                  name="captcha"
